...
export let DinamicPrice = {
    ...
    fnc: function(response) {
        ...
        if (response.offer != "") {
            ...
            // Si la fecha actual es menor a la fecha de oferta sigue vigente la oferta
            if(today < offerDate) {
...
export let Search = {
    ...
    fnc: function(response) {
        ...
        // Si en search tiene diferentes expresiones que no esten en match 
...
export let Quantity = {
    ...
    fnc: function() {
        ...
        $(".quantity").each(function() {
            ...
            // Subiendo numeros con la flechita
            ...
            // Bajando numeros con la flechita
